...
class ApiConstant {
    ...
    companion object {
        ...
        const val FETCH_PULL_REQUEST_COMMITS = "2.0/repositories/{repo_full_name}/pullrequests/{pull_request_id}/commits"
        const val FETCH_PULL_REQUEST_COMMENTS = "2.0/repositories/{repo_full_name}/pullrequests/{pull_request_id}/comments"
